...
export function SheafMessageBubble(props: {
  ...
  return (
    ...
    <div className= "bg-slate-50  rounded-lg px-4   h-fit align-center my-auto py-[1.2px] tracking-wide max-w-[60%] 
    bg-opacity-70 sheaf-bubble outline-transparent text-[.9rem]  text-slate-950 dark:bg-slate-50 dark:text-slate-900">
      {facets.length > 1 && (
