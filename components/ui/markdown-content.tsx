...
const DEFAULT_PRE_BLOCK_CLASS =
	"my-4 overflow-x-auto w-fit rounded-xl bg-zinc-950 text-zinc-50 dark:bg-zinc-900 border border-slate-200 p-4 dark:border-slate-800";
...
const components: Partial<Components> = {
	...
	code: ({ children, node, className, ...props }) => {
		...
		return (
			<code
				className={cn(
					"rounded bg-slate-100 px-[0.3rem] py-[0.2rem] font-mono text-sm dark:bg-slate-800",
					className,
				)}
				{...props}
			>
