      ...
      <DialogContent className="max-w-3xl max-h-screen overflow-hidden panel-edge-blue
       bg-gradient-to-b from-sky-100/55 via-white/50 to-sky-50/50 backdrop-blur-xl shadow-2xl px-6 py-8">
        ...
        <div className="relative z-10 overflow-y-auto max-h-[85vh] custom-scrollbar-light px-2">
          <DialogHeader className="space-y-3 pb-3 border-b border-slate-900/10">
            ...
            {targetLabel && (
              <p className="w-fit ml-1 text-xs border  panel-edge-blue rounded-lg bg-sky-700/70 text-white leading-relaxed px-3 py-1">
                {targetLabel}
              </p>
            )}
              ...
              {MOVE_TYPES.map((type) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group relative flex flex-col items-start gap-2 px-4 py-3  rounded-xl transition-all duration-300",
                      "backdrop-blur-md  shadow-lg overflow-hidden",
                      isSelected
                        ? "panel-edge border-cyan-500/60 bg-gradient-to-br from-cyan-300/20 to-sky-300/20 shadow-cyan-400/20 scale-[1.02]"
                        : "panel-edge border-indigo-200/60 bg-white/45 shadow-slate-400/80 hover:bg-sky-100/40  hover:scale-[1.01]",
                  ...
                  >
                    ...
                    <span className={cn(
                      "text-sm leading-relaxed transition-colors duration-300 relative",
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Textarea
                ...
                className="articlesearchfield min-h-[100px] resize-y bg-white/80 px-3 pt-2.5 pb-3 text-slate-900 placeholder:text-slate-400   rounded-xl "
              />
              <div className="absolute bottom-3 right-3 text-xs text-slate-500 bg-white/80 px-2 py-0 rounded-md backdrop-blur-sm border border-slate-900/10">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="e.g., Modus Ponens, Argument from Authority, etc."
                className="articlesearchfield w-full py-2 text-xs px-3 resize-y bg-white/80 backdrop-blur-md  text-slate-900 placeholder:text-slate-400   rounded-lg "
            />
          </div>

          {/* ─── Info Banner ────────────────────────────────────────── */}
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-sky-400/15 to-cyan-400/15 backdrop-blur-md border border-cyan-500/30 py-3 px-3 shadow-lg">
        ...
        {/* ─── Footer Actions ─────────────────────────────────────── */}
        <div className="relative flex items-center justify-between pt-3 mb-3 mt-2 border-t border-slate-900/10">
          <button
            onClick={() => onOpenChange(false)}
            disabled={isSubmitting}
            className="btnv2 text-sm px-3 py-2 rounded-xl bg-slate-400/10 backdrop-blur-md border-slate-200/20 text-slate-700 hover:bg-slate-200/10 hover:border-slate-200/30 transition-all"
          >
          ...
          <button
            ...
            className="relative overflow-hidden btnv2 text-sm rounded-xl text-white px-4 py-2.5
