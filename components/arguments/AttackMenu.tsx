...
type Props = {
  onSelect: (sel: { attackType: 'REBUTS'|'UNDERCUTS'|'UNDERMINES'; targetScope: 'conclusion'|'inference'|'premise' }) => void;
};
  ...
  return (
    <div className="flex gap-2 flex-wrap">
      <button className="px-3 py-1 rounded-full bg-red-100 hover:bg-red-200"
        title="Dispute the claim’s truth"
