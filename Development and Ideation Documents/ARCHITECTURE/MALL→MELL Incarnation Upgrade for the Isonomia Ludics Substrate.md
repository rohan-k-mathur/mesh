...
- **Q-036.** Confirm no published errata to BF 2011 or FQ 2013. (FQ 2013 LMCS is itself a "revised and corrected version," republished 2015; BF Remark 11.12 flags an unproved finiteness loose-end.)
  - **→ R1 DISCHARGED 2026-06-16.** The three LMCS article pages were checked directly and carry **no errata/corrigenda on the load-bearing papers**. FQ 2013 (LMCS 9(4:6)2013, arXiv:1307.1028) is published with the comment *“33 pages, revised and corrected version”* — the **version of record already incorporates the correction** (so the “which FQ version?” worry is retired); its zbMATH review (Zbl 1319.03063) notes no further correction. BF 2011 (LMCS 7(2:13)2011, arXiv:1104.0504) shows no corrigendum notice, and its abstract confirms the load-bearing *“we use less properties than in the original formulation”* (separation-drop). FQ 2018 (LMCS 14(2:7)2018, the non-load-bearing companion) is clean. **Residual, non-blocking:** (R2) BF Remark 11.12's postponed finiteness loose-end (PDF/citing-work trace) and (R3) theorem-number alignment against the latest PDFs — neither gates the upgrade; BF numbering was already cross-checked against the LICS 2009 short version (see Caveats). Full record: [Q-036 in the OQ registry](../../RESEARCH_PROGRAMME/01_OPEN_QUESTIONS_REGISTRY.md#q-036).
