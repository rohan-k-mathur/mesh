...
const ProposeStructuredArgumentInput = z.object({
    ...
    evidence: z
        ...
        .optional()
        .default([])
        .describe("Up to 10 evidence sources. **v1 attaches all evidence to the conclusion claim** (per-premise evidence ships in v1.1). Each item should provide `quote` OR `summary`. Pair with `resolve_citation` first when given a DOI / arXiv id / publisher URL."),
