...
const tools = [
    ...
    {
        name: "get_argument",
        description: "Fetch the full attestation envelope for an argument permalink. Includes conclusion, premises, scheme, evidence with provenance (sha256 + archive URL), and dialectical status (attacks, supports, CQ counters, standing score).",
    ...
    },
    {
        ...
        description: "Find counter-arguments, objections, rebuttals, attacks, and dissenting positions against a target claim. Accepts a MOID (preferred) or free text. Returns arguments whose conclusion contests the target; arguments with the same conclusion MOID are excluded so an empty result is honestly empty (no false counters). v0 uses textual stance heuristics; a true negation/contradiction index ships with Track C.2.",
    ...
    {
        name: "cite_argument",
        description: "Return a ready-to-paste citation block for an Isonomia argument: canonical permalink, immutable content-hashed URL, retrieval timestamp, conclusion pull quote, dialectical status (with explicit standingState so 'untested-default' is not confused with 'tested-survived'), premise/evidence provenance counters (so unattested premises are surfaced honestly), and — by default — the strongest known counter-argument so the citation arrives with its opposition attached.",
