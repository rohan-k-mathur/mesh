# Catalogue-redundancy audit — argument-scheme rows

- **generated at:** 2026-05-31T02:38:41.212Z
- **spec:** SCHEMES_IMPL_VERIFIER.md §5 Phase 4d
- **roadmap step:** FROM_FOLKSONOMY_TO_ONTOLOGY_SCHEMES.md step 18
- **schemes considered:** 24 (kind='argument-scheme')
- **pairs verified:** 276 (all-pairs, cross-family included)
- **verdict totals:** equal=0, subset=0, incomparable=276, inconclusive=0

## Equal pairs (require follow-on issue per pair)

None. Catalogue is `equal`-clean at this snapshot.

## Subset pairs (require follow-on issue per pair)
...
## Cross-family vs within-family breakdown

| scope | pairs | equal | subset | incomparable | inconclusive |
|---|---|---|---|---|---|
| within-family | 41 | 0 | 0 | 41 | 0 |
| cross-family | 235 | 0 | 0 | 235 | 0 |
...
| `practical_reasoning` | `practical_reasoning_family` | 6 | `5bfb2b53d62a431f4de84c07d392f93b86e972d972ec9b8a2a2e0b9327a0c4e4` |
